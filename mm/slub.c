 ...
 * Returns false if the allocation should fail.
 */
static __fastpath_inline bool memcg_slab_pre_alloc_hook(struct kmem_cache *s,
					     struct list_lru *lru,
					     struct obj_cgroup **objcgp,
					     size_t objects, gfp_t flags)
{
	...
	return likely(__memcg_slab_pre_alloc_hook(s, lru, objcgp, objects, flags));
}
...
static __fastpath_inline void memcg_slab_post_alloc_hook(struct kmem_cache *s,
					      struct obj_cgroup *objcg,
					      gfp_t flags, size_t size,
					      void **p)
{
...
static __fastpath_inline void memcg_slab_free_hook(struct kmem_cache *s, struct slab *slab,
						   void **p, int objects)
{
	struct obj_cgroup **objcgs;
...
static __fastpath_inline struct kmem_cache *slab_pre_alloc_hook(struct kmem_cache *s,
						     struct list_lru *lru,
						     struct obj_cgroup **objcgp,
...
static __fastpath_inline void slab_post_alloc_hook(struct kmem_cache *s,
