...
/**
 * folio_slab - Converts from first struct page to slab.
 * @p: The first (either head of compound or single) page of slab.
 *
 * A temporary wrapper to convert struct page to struct slab in situations
 * where we know the page is the compound head, or single order-0 page.
 *
 * Ideally everything would work with struct slab directly or go through folio
 * to slab.
 *
...
{
	struct folio *folio = page_folio(virt_to_page(addr));
